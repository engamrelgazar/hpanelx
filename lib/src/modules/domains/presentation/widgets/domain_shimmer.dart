...
class DomainShimmer extends StatelessWidget {
  final bool isTablet;

  const DomainShimmer({super.key, required this.isTablet});
        ...
        child: Shimmer.fromColors(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildShimmerLine(context, lineWidth * 1.8, lineHeight),
              SizedBox(height: ResponsiveHelper.h(8, context)),
              _buildShimmerLine(context, lineWidth, lineHeight),
            ],
          ),
        ),
      ),
